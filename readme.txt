...
Donate link: http://pathartl.me/
Tags: twitter, tweeter, widget, tweet, feed
...
1. A screenshot of Tweeter! in action.
...
= 1.1.0 =
* Please update immediately! Fixed the entire plugin.

= 1.0.0 =
* No reason to upgrade, it's the initial release!